    ...
    export default defineComponent({
        ...
        methods: {
           adicionarProjeto(){
                ...
                useProjetosStore().adicionarProjeto(novoProjeto); //Não há necessidade de criar uma instância para store em todo componente, basta usar useObjetoStore, já que a instância é única
                this.nomeProjeto = ''
